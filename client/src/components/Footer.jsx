  ...
  return (
    <footer id="contact" className="bg-[#1a1a1a] text-white">
        ...
        <div className="grid lg:grid-cols-3 gap-16">
          ...
          <div className="text-right">
            ...
            <div className="space-y-2">
              ...
              <a href="tel:+14168576183" className="block text-sm text-white hover:text-gray-400 transition-colors" style={{ fontFamily: "'Inter', sans-serif" }}>+1 (416) 857-6183</a>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 pb-8 overflow-visible">
        <h2 className="font-bold leading-none select-none tracking-tight whitespace-nowrap footer-brand-name" style={{ transform: 'translateX(-4%)', fontSize: 'min(12vw, 160px)', lineHeight: '1' }}>
