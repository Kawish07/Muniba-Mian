        ...
        <>
            ...
            {createPortal(
                ...
                >
                    ...
                    >
                        <Link to="/" className="flex flex-col items-center gap-1 px-5 py-2 rounded bg-pink-500 hover:bg-pink-400 transition-all duration-300">
                        ...
                        <Link to="/all-listings" className="flex flex-col items-center gap-1 px-4 py-2 rounded hover:bg-white/10 transition-all duration-300">
                        ...
                        <button onClick={() => setContactOpen(true)} className="flex flex-col items-center gap-1 px-4 py-2 rounded hover:bg-white/10 transition-all duration-300">
                            <svg className="w-5 h-5 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                        ...
                        <Link to="/our-team" className="flex flex-col items-center gap-1 px-4 py-2 rounded hover:bg-white/10 transition-all duration-300">
                            <svg className="w-5 h-5 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                        ...
                        <Link to="/staging" className="flex flex-col items-center gap-1 px-4 py-2 rounded hover:bg-white/10 transition-all duration-300">
                            <svg className="w-5 h-5 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
